                ...
                <>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div className="space-y-1">
                            ...
                            <input type="number" inputMode="numeric" min={1} max={10} value={columns} onChange={e => setColumns(+e.target.value)}
                        ...
                        <div className="space-y-1">
                            ...
                            <input type="number" inputMode="numeric" min={0} max={50} value={spacing} onChange={e => setSpacing(+e.target.value)}
                                className="w-full rounded-lg border border-border bg-secondary/30 px-3 py-2 text-sm text-foreground focus:outline-none text-center" />
                        </div>
                        <div className="space-y-1">
